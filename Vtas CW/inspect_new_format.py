"""
Inspect the NEW format file: Libros IVA ventas desde 2011 2021.xlsx
This script is READ-ONLY. It does NOT modify any files.
"""
import pandas as pd
import sys

FILE_PATH = r"c:\Users\Tuchi\MiEstudioIA\Vtas CW\data\input\Libros IVA ventas desde 2011 2021.xlsx"
...
try:
    ...
    for sheet_name in xls.sheet_names:
        ...
        # Show first 15 rows raw (no header assumption)
        print(f"\n--- First 15 rows (raw, no header) ---")
